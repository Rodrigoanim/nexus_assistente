...
st.set_page_config(
    page_title="CHAVE Comportamental - v.2.2c",  # Título na Aba do Navegador
    page_icon="🔑",
    layout="centered",
    menu_items={
        'About': """
        ### Plataforma C.H.A.V.E. Comportamental - v.2.2c
...
def show_assessment_selector():
    ...
    with col1:
        selected_assessment = st.selectbox(
            "Selecione o Assessment que deseja e, avance pelas 3 etapas: Parte 1, Parte 2 e Resultados.",
        ...
        if selected_assessment:
            ...
            try:
                ...
                if show_results:
                    ...
                    titulo_pagina = f"Análise Administrativa - {admin_user_name} - {assessment_name} - v.2.2c"
