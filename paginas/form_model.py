...
def process_forms_tab(section='perfil'):
    ...
    try:
        ...
        titles = {
            'fdireta': "Função de Avaliação de Direta",
            'finvertida': "Função de Avaliação de Invertida",
            'resultado': "Função de Resultados"
        }
        
        title_text = titles.get(section, "Mòdulo de Avaliação de Direta e Invertida")
        st.markdown(f"""
            <p style='
                text-align: left;
                font-size: 28px;
