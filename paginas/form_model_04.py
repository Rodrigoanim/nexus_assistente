...
def process_forms_tab_04(section='perfil'):
    ...
    try:
        ...
        titles = {
            'armadilhas_p1': "📋 Parte 1 - Armadilhas do Empresário",
            'armadilhas_p2': "✏️ Parte 2 - Armadilhas do Empresário", 
        ...
        # Verifica se estamos no assessment "04" (Armadilhas do Empresário)
