# Arquivo: form_model_recalc_05.py
# Data: 20/01/2025
# Versão multi-assessment: Anamnese Completa (Assessment 05)
# Rotina de recálculo de fórmulas para forms_tab_05
...
def verificar_dados_usuario_05(cursor, user_id):
    """Verifica/copia dados do template (user_id=0) para novo usuário na forms_tab_05"""
    try:
        cursor.execute("SELECT COUNT(*) FROM forms_tab_05 WHERE user_id = ?", (user_id,))
...
def calculate_formula_05(cursor, name, user_id):
    """Calcula o valor de uma fórmula na forms_tab_05"""
    try:
        cursor.execute("""
            SELECT math_element 
            FROM forms_tab_05 
...
def atualizar_formulas_05(cursor, user_id):
    """
    Atualiza todas as fórmulas em ordem específica para um determinado usuário na forms_tab_05
    """
    try:
        cursor.execute("""
        ...
        for formula in formulas:
            ...
            result = calculate_formula_05(cursor, name_element, user_id)
