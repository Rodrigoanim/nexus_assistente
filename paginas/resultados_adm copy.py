                    ...
                    with col2:
                        if tem_analises:
                            ...
                            if st.button("🔍 **Visualizar Análises DISC**", use_container_width=True, type="primary"):
                                ...
                                st.markdown("---")
                                st.markdown(f"### 📊 Análise DISC - {usuario_info['Nome']}")
                                
                                # Chamar o módulo resultados.py passando o user_id selecionado
                                show_results(
                                    tabela_escolhida="forms_resultados",
                                    titulo_pagina=f"Análise Administrativa - {usuario_info['Nome']}",
                                    user_id=user_id_selecionado
                                )
                        else:
